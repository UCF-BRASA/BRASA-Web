...
const GridSection: FC<Props> = ({ imageAlt, imagePath, title, description }) => {
  return (
    <div className="flex flex-col justify-between items-center text-center h-[15rem]">
      ...
      <p className="font-large text-base text-black/60 w-auto break-normal">{description}</p>
    </div>
  );
};
