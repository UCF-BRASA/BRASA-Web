// import { EventCard, GridSection, JoinNewsletter } from "@components";
...
//         {/* <div className="absolute -top-0 -right-1/4 w-2/3 overflow-hidden rounded-full"> */}
//         <div className="absolute -top-[-10rem] -right-[10rem] w-[50rem] aspect-square overflow-hidden rounded-full shadow-xl">
//           <Image
